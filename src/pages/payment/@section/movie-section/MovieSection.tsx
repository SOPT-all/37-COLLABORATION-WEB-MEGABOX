        ...
        <div className='py-[0.6rem]'>
          ...
          <div className='flex gap-[1.3rem]'>
            ...
            <div className='flex flex-col justify-items-start gap-[0.4rem]'>
              <h3 className='font-body3 text-gray-900'>{title}</h3>
              <p className='font-caption1 text-gray-500'>{showTime}</p>
              <p className='font-caption1 text-gray-500'>{theater}</p>
              <p className='font-label2 text-violet-600'>{`성인 ${seats}`}</p>
            </div>
          </div>
        </div>
      </section>
