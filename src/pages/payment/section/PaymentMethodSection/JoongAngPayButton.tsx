...
const JoongAngPayButton = () => {
  return (
    <div className='mb-[1.6rem]'>
      <button type='button' className='flex w-full items-center justify-between rounded-[0.4rem] border border-gray-300 px-[2rem] py-[0.6rem]'>
        <img
          src='/assets/img-joonang-logo.svg'
          alt='JoongAng PAY'
          className='h-[3.2rem]'
        />
